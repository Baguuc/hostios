#[actix_web::delete("/directories/{path}")]
pub async fn controller(
    ...
    use crate::errors::use_case::DirectoryDeleteError as Error;
    ...
    match DirectoriesUseCase::delete(&params, &_authios_sdk.into_inner(), &fql_client.into_inner()).await {
        ...
        Err(error) => return match error {
            ...
            Error::NotEmpty => HttpResponse::Conflict().body(error.to_string())
        }
    };
}
